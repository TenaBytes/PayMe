...
import { TrendingUp, LayoutDashboard, Wallet, History, Settings, LogOut, Menu, Bell } from "lucide-react"
...
const navigation = [
  ...
  { name: "Profile", href: "/dashboard/profile", icon: Bell },
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 shrink-0 items-center px-6 border-b">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold">WealthNexus</span>
        </div>
      </div>
